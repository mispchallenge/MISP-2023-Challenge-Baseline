...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
    echo "prepare video"
    middle_field_video_data=/mnt/201_disk6/mkhe/dataset/misp2021/video/train/middle/
    raw_segments=$store_dir/segments
    roi_json_dir=/mnt/201_disk6/mkhe/dataset/misp2021/detection_results/train/middle/
    roi_store_dir=/disk3/chime/simulation/gss_main/train_video
    python prepare_files.py --data_root $middle_field_video_data --file_root $store_dir --segments $raw_segments
    python video_roi_train.py -ji 0 -nj 4 --data_root $middle_field_video_data --file_root $store_dir --roi_json_dir $roi_json_dir --roi_store_dir $roi_store_dir
